...
This game is an [Open Artifacts](https://openartifacts.org/) project. If you are interested in contributing to making this game better or would like to create a different game based on this one, [please visit the project page](https://github.com/jimappleg8/crystal-word-chain). The game is licensed under the Apache License 2.0.
